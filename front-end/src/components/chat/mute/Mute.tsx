...
function Mute({ onClose, isVisible, user: user }: MuteProps): ReactElement {
    if ( !isVisible ) return(<></>);
        ...
        <div className={muteStyles.ctn_pck_box} id="wrapper" onClick={handleClose}>
            <div className={muteStyles.ctn_box}>
                ...
                <div className={muteStyles.ctn_presentation}>
                    <p className={muteStyles.style_text}>Please indicate how many minutes you would like to mute :</p>
                    <p className={muteStyles.style_username}>{user?.username}</p>
                </div>
                <div className={muteStyles.ctn_input}>
                    <input type="number" placeholder='minutes' className={muteStyles.style_input} />
                </div>
