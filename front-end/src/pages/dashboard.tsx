				...
				<div className={dashStyles.ctn__dash}>
					<div className={dashStyles.dash__profile}>
						<div className={dashStyles.pict__prof}>
							<img className={dashStyles.img__prof} src="https://cdn.intra.42.fr/users/f7c9f497be15126143ee5a3e2a5d4f82/mlarboul.jpg" alt="" />
						</div>
					...
					<div className={dashStyles.dash__data}>
						...
						<div className={dashStyles.hist__party}>
							<div className={dashStyles.pict__player}>
								<img className={dashStyles.img__player} src="https://cdn.intra.42.fr/users/f7c9f497be15126143ee5a3e2a5d4f82/mlarboul.jpg" alt="" />
							</div>
							<p className={dashStyles.rst__match}>16 - 17</p>
							<div className={dashStyles.pict__player}>
								<img className={dashStyles.img__player}  src="https://cdn.intra.42.fr/users/a2cb081e3eab21713f87e1a938325f68/piboidin.jpg" alt="" />
							</div>
						</div>
						<div className={dashStyles.hist__party}>
							<div className={dashStyles.pict__player}>
							...
							<div className={dashStyles.pict__player}>
								<img className={dashStyles.img__player} src="https://cdn.intra.42.fr/users/f9f6e861c01bbc4e5e4ead4615fbcbe0/flohrel.jpg" alt="" />
							</div>
						</div>
						<div className={dashStyles.hist__party}>
							<div className={dashStyles.pict__player}>
								<img className={dashStyles.img__player} src="https://cdn.intra.42.fr/users/736968882f4340a00b83bfa9fbcc8bd8/kmazier.jpg" alt="" />
							</div>
						...
						<div className={dashStyles.hist__party}>
							<div className={dashStyles.pict__player}>
								<img className={dashStyles.img__player} src="https://cdn.intra.42.fr/users/06cf823c954721e18942bee2dde06b17/jmazoyer.jpg" alt="" />
							</div>
